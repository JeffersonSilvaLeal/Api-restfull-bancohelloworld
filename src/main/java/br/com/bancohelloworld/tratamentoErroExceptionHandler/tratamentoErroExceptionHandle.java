package br.com.bancohelloworld.tratamentoErroExceptionHandler;
...
@ControllerAdvice
public class tratamentoErroExceptionHandle extends ResponseEntityExceptionHandler {
	...
	//Tratando quando não houve registro para Remover do Banco de dados
